...
import { GuildsRoute, CommandsRoute, UsersRoute, FeaturesRoute } from './routes';
...
class Server {
  ...
  registerRoutes() {
      ...
      this._app.use('/features', new FeaturesRoute(this._client, this._apiEventEmitter).setup());
  }
} 
